...
From hot to cold metal lockup; to photographic and xerographic paste-up; to Bézier curves and PostScript; and from paper to screen; to paperless workflows and online publishing with PDF, HTM, and CSS; to the easy-to-read, easy-to-write text-to-HTML formatting syntax, Markdown, and the desktop publishing champion, InDesign; to the manifestation of human friendly markup and style for printers, screens, and designers alike. The tools and technology of the design industry, past and present, inspire and govern our process and output. How we decide and define the design language, tools, and workflows we use — should be as meaningful as the content and intent in which we design and layout.
